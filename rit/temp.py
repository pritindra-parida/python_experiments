### JSON File Name is Same as the HTML File Name    
...
# Extract the base name of the HTML file (without extension)
...
json_file_name = os.path.join(save_path, f"{base_name}.json")
